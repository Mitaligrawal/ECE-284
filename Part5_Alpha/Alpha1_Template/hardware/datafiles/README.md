datafiles/ — input vectors for Alpha1_Template

This directory should contain the input data files used by the Alpha1 testbench and validation scripts.
...
- If your testbench expects different filenames or formats, document that in `Part5_Alpha/Alpha1_Template/hardware/README.md`.
